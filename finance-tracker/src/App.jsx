    ...
    return (
        <div className="min-h-screen bg-gray-50 flex justify-center">
            <div className="w-full max-w-md bg-white shadow-2xl overflow-hidden relative min-h-screen flex flex-col">
                ...
                {/* Content */}
                <main
                    className={`flex-1 overflow-y-auto px-6 pb-28 scrollbar-hide ${user?.isActive === false
                ...
                {/* Bottom Nav */}
                <nav
                    className={`absolute bottom-0 w-full bg-white border-t border-gray-100 px-8 pb-6 pt-2 flex justify-between items-end z-20 h-24 ${user?.isActive === false ? "filter blur-sm pointer-events-none" : ""
                        }`}
                >
                    <NavItem
                        icon={Home}
