...
const AdminScreen = ({
    ...
    const [editBalance, setEditBalance] = useState(currentUserData.balance);
    ...
    useEffect(() => {
        ...
        setEditBalance(currentUserData.balance);
                    ...
                    <section>
                        ...
                        <div className="bg-gray-800 p-5 rounded-3xl border border-gray-700">
                            <div className="flex justify-between items-center mb-4">
                                <div className="flex items-center gap-3">
                                    <div
                                        className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold ${currentUserData.isActive ? "bg-blue-600" : "bg-red-500"
                                            }`}
                                    >
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-8 pr-4 py-3 rounded-2xl bg-gray-900 border border-gray-600 text-white outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                                        />
                                    </div>
                                    <p className="text-xs text-gray-500 mt-1 ml-1">
                                        System will add an adjustment transaction.
                                    </p>
                                </div>
                                ...
                                <div className="bg-gray-900 p-3 rounded-2xl border border-gray-600 flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className={`w-12 h-6 rounded-full p-1 transition-colors duration-200 ease-in-out ${editActive ? "bg-green-500" : "bg-red-500"
                                            }`}
                                    >
                                        <div
                                            className={`w-4 h-4 bg-white rounded-full shadow-md transform transition-transform duration-200 ${editActive ? "translate-x-6" : "translate-x-0"
                                                }`}
                                        ></div>
                                    </button>
                                </div>
